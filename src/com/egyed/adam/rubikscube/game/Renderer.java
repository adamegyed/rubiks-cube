...
import com.egyed.adam.rubikscube.engine.Util;
import com.egyed.adam.rubikscube.engine.graphics.Camera;
import com.egyed.adam.rubikscube.engine.graphics.ShaderProgram;
import com.egyed.adam.rubikscube.engine.graphics.Mesh;
import com.egyed.adam.rubikscube.engine.graphics.Transformation;
...
public class Renderer {
    ...
    public void init(MainWindow mainWindow) throws Exception {
        ...
        shaderProgram.createVertexShader(Util.loadResource("/resources/vertex.vert"));
        shaderProgram.createFragmentShader(Util.loadResource("/resources/fragment.frag"));
        shaderProgram.link();
